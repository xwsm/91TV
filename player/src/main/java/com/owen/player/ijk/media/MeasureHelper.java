...
public final class MeasureHelper {
    private static String TAG = MeasureHelper.class.getSimpleName() + " @@@@@ %s";
    ...
    public void doMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        EPLog.i(TAG, "######## mVideoWidth="+mVideoWidth+" ,mVideoHeight="+mVideoHeight +" ########");

        int width = View.getDefaultSize(mVideoWidth, widthMeasureSpec);
        int height = View.getDefaultSize(mVideoHeight, heightMeasureSpec);

        EPLog.i(TAG, "width="+width+" ,height="+height);
        EPLog.i(TAG, "mCurrentAspectRatio："+mCurrentAspectRatio+"IRenderView.AR_MATCH_PARENT："+IRenderView.AR_MATCH_PARENT);
        if (mCurrentAspectRatio == IRenderView.AR_MATCH_PARENT) {
            ...
            EPLog.i(TAG, "widthSpecSize="+widthSpecSize+" ,heightSpecSize="+heightSpecSize+"widthSpecMode="+widthSpecMode
                ...
                switch (mCurrentAspectRatio) {
                    ...
                    default:
                        ...
                        if(displayAspectRatio > 1.2f && displayAspectRatio < 1.34f) {
                            EPLog.i(TAG, "displayAspectRatio=");
                            displayAspectRatio = 16.0f / 9.0f;
                            if (TextUtils.equals("KTU84M", android.os.Build.ID)){
                                EPLog.i(TAG, "长虹5508");
                                displayAspectRatio = 4.0f / 3.0f;
                            }
                        }
                        if (mVideoSarNum > 0 && mVideoSarDen > 0){
                            EPLog.i(TAG, "here5:"+mVideoSarNum+":::"+mVideoSarDen);
                            displayAspectRatio = displayAspectRatio * mVideoSarNum / mVideoSarDen;
                            EPLog.i(TAG, "here55:"+displayAspectRatio);
                        }
                        break;
                }
                boolean shouldBeWider = displayAspectRatio > specAspectRatio;
                EPLog.i(TAG, "shouldBeWider:"+shouldBeWider);
        ...
        EPLog.i(TAG, "mMeasuredWidth="+mMeasuredWidth+" ,mMeasuredHeight="+mMeasuredHeight);
    }
